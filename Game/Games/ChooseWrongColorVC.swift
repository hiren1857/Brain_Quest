...
class ChooseWrongColorVC: UIViewController {
    ...
    @objc func leftButtonTapped() {
        ...
        VC.arrInstructions = Singleton.sharedInstance.arrGameInstructions[11] as! [NSDictionary]
        VC.strGameName = "Choose Wrong Color"
        VC.isGame = true
    ...
    func setColors() {
        ChooseWrongColorVC.DropShadow(views: [scoreVw])
        ...
        for i in 0..<arrDisplaedColors.count
        {
            ...
            arrDisplaedUIColors.add(arrNineUIColors[color_UI_index])
        }
    ...
    @objc func updateTimer() {
        if seconds > 0 {
            ...
            timer.invalidate()
            DEFAULTS.Set_Best_Score_Of_ChoseWrongColor(Score: lblScore.text!, mode: strLevel)
    ...
    func gameOver() {
        ...
        VC.highestScore = "Highest Score : \(DEFAULTS.Get_Best_Score_Of_ChoseWrongColor(mode: strLevel))"
...
extension ChooseWrongColorVC : UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return arrDisplaedUIColors.count
    }
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if rightColorIndex == indexPath.row {
            cell.lblBg.backgroundColor = arrDisplaedUIColors[rightColorIndex] as? UIColor
            cell.lblNumber.text = arrDisplaedColors[wrongColorIndex] as? String
        } else {
